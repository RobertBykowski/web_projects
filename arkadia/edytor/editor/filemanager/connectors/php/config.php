...
$Config['Enabled'] = user::get()->adminUpload();


// Path to user files relative to the document root.
$Config['UserFilesPath'] = konf::get()->getKonfigTab("upload") ;
...
$Config['ConfigAllowedCommands'] = array('QuickUpload', 'FileUpload', 'GetFolders', 'GetFoldersAndFiles', 'CreateFolder','DeleteFile','RecaptionFile','RenameFile','ResizeFile','RotateFile') ;	
