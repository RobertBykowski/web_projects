...
function selectItem(li) {
	if (li.extra) {
		uzytkowniko=li.selectValue;			
		document.getElementById('id_u').value=li.extra[0];
	}
}

function formatItem(row) {

	szukaj=document.getElementById('uzytkownik').value;
	wys=row[0].replace(szukaj,'<b>'+szukaj+'</b>');
	return wys;
