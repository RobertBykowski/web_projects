...
function slider (a_init, a_tpl) {
	...
	document.write(
		'<div style="width:' + this.n_controlWidth + 'px;height:' + this.n_controlHeight + 'px; border:1px solid #989ba1; background-repeat:repeat-x; background-position:top left; background-image:url(' + this.s_imgControl + ')" id="sl' + this.n_id + 'base">' +
